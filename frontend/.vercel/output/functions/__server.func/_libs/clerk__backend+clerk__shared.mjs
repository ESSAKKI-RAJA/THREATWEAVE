...
var getEnvVariable = (name, context) => {
	...
	if (typeof import.meta !== "undefined" && typeof {
		...
		"VITE_CLERK_PUBLISHABLE_KEY": "pk_test_ZGlzdGluY3QtZWdyZXQtOTguY2xlcmsuYWNjb3VudHMuZGV2JA",
		"VITE_SUPABASE_PROJECT_ID": "fsqqxjjwdqoydbvlsgjd",
		"VITE_SUPABASE_PUBLISHABLE_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZzcXF4amp3ZHFveWRidmxzZ2pkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODE4MDAxNzEsImV4cCI6MjA5NzM3NjE3MX0.fKrwuS3TRvfmDNaM7jHZSv_xf90OHNQCyXhuEQmo9SU",
		"VITE_SUPABASE_URL": "https://fsqqxjjwdqoydbvlsgjd.supabase.co"
	}[name] === "string") return {
		"BASE_URL": "/",
		"DEV": false,
		"MODE": "production",
...
//#endregion
export { isReverificationHint as A, LOCAL_ENV_SUFFIXES as C, createCheckAuthorization as D, STAGING_ENV_SUFFIXES as E, isClerkAPIResponseError as F, ClerkRuntimeError as I, isTruthy as M, getEnvVariable as N, resolveAuthState as O, buildErrorThrower as P, LOCAL_API_URL as S, STAGING_API_URL as T, createDevOrStagingUrlCache as _, createClerkRequest as a, parsePublishableKey as b, addClerkPrefix as c, isValidProxyUrl as d, proxyUrlToAbsoluteURL as f, isDevelopmentEnvironment as g, isAutomatedEnvironment as h, constants as i, reverificationError as j, validateReverificationConfig as k, isHttpOrHttps as l, eventMethodCalled as m, dist_exports as n, debugRequestState as o, retry as p, AuthStatus as r, deprecated as s, createClerkClient as t, isProxyUrlRelative as u, isDevelopmentFromPublishableKey as v, PROD_API_URL as w, LEGACY_DEV_INSTANCE_SUFFIXES as x, isDevelopmentFromSecretKey as y };
